...
async def test_parent_selector_shows_hierarchical_paths(
    ...
    assert "Frame Options &gt; Material Type" in content or "Frame Options > Material Type" in content
    assert "Frame Options &gt; Material Type &gt; Aluminum" in content or "Frame Options > Material Type > Aluminum" in content
