...
from app.services.quote import QuoteService, QuoteManagement, QuoteReader, AdminQuoteAccess
...
class TestQuoteServiceCasbin:
    ...
    @pytest.mark.asyncio
    async def test_generate_quote_uses_customer_id_from_configuration(self, mock_db, sample_user, sample_configuration):
    ...
    @pytest.mark.asyncio
    async def test_generate_quote_casbin_decorator_authorization(self, mock_db, sample_user, sample_configuration):
    ...
    @pytest.mark.asyncio
    async def test_get_quote_multiple_decorators_or_logic(self, mock_db, sample_user, sample_admin, sample_quote):
    ...
    @pytest.mark.asyncio
    async def test_quote_customer_relationship_consistency(self, mock_db, sample_user, sample_configuration):
    ...
    @pytest.mark.asyncio
    async def test_quote_totals_calculation_with_customer_context(self, mock_db, sample_user, sample_configuration):
        ...
        expected_tax = (expected_subtotal * Decimal("8.50") / Decimal("100")).quantize(Decimal("0.01"))
