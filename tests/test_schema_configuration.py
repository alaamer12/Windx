...
def test_schema_configuration():
    ...
    if same_database:
        ...
        print(f"   Tests will NOT affect development data!")
    else:
...
async def test_schema_in_connection(test_engine):
    ...
    async with test_engine.begin() as conn:
        ...
        print(f"Configuration is set to use test_windx schema")
    ...
    async with test_engine.begin() as conn:
        ...
        if public_tables > 0:
            ...
            try:
                ...
                print(f"   ✅ Can READ from public schema")
            ...
            print(f"   ✅ Public schema data is protected")
        else:
            print(f"\n⚠️  No tables in public schema yet")
            print(f"   Run: python manage.py clean_db")
            print(f"   Then: python manage.py seed_data")
