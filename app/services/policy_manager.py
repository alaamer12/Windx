...
class PolicyManager(BaseService):
    ...
    async def add_policy(
        ...
        try:
            ...
            if result:
                ...
                logger.info(
                    f"Added policy: {subject} -> {resource}:{action} ({effect})"
                )
    ...
    async def remove_policy(
        ...
        try:
            ...
            if result:
                ...
                logger.info(
                    f"Removed policy: {subject} -> {resource}:{action} ({effect})"
                )
    ...
    async def assign_customer_to_user(
        ...
        try:
            ...
            result = self.enforcer.add_grouping_policy(
                user_email, "customer", str(customer_id)
            )
            ...
            if result:
                ...
                logger.info(
                    f"Assigned customer {customer_id} to user {user_email}"
                )
    ...
    async def remove_customer_assignment(
        ...
        try:
            ...
            result = self.enforcer.remove_grouping_policy(
                user_email, "customer", str(customer_id)
            )
            ...
            if result:
                ...
                logger.info(
                    f"Removed customer {customer_id} assignment from user {user_email}"
                )
    ...
    async def get_user_customer_assignments(self, user_email: str) -> List[int]:
        ...
        try:
            ...
            for grouping in groupings:
                if (len(grouping) >= 3 and 
                    grouping[0] == user_email and 
                    grouping[1] == "customer"):
                    try:
    ...
    async def backup_policies(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise PolicyEvaluationException(
                "Failed to create policy backup",
                {"error": str(e)}
            )
    ...
    async def restore_policies(self, backup_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            raise PolicyEvaluationException(
                "Failed to restore policies from backup",
                {"error": str(e)}
            )
    ...
    async def validate_policies(self) -> Dict[str, Any]:
        ...
        try:
            ...
            validation_results["statistics"] = {
                ...
                "role_assignments": len([g for g in groupings if len(g) >= 2 and g[1] in [r.value for r in Role]])
            }
        ...
        try:
            ...
            summary = {
                ...
                "statistics": {
                    ...
                    "total_customer_assignments": sum(len(customers) for customers in customer_assignments.values()),
    ...
    async def seed_initial_policies(self) -> None:
        ...
        try:
            ...
            raise PolicyEvaluationException(
                "Failed to seed initial policies",
                {"error": str(e)}
            )