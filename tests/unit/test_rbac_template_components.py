...
class TestRBACButton:
    ...
    def test_button_renders_with_permission(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_button_hidden_without_permission(self, jinja_env, mock_user_customer, mock_can_helper_restricted, mock_has_helper):
    ...
    def test_button_renders_with_role(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_button_hidden_without_role(self, jinja_env, mock_user_customer, mock_can_helper, mock_has_helper):
    ...
    def test_button_with_icon(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_button_with_custom_class(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
...
class TestRBACNavItem:
    ...
    def test_nav_item_renders_with_permission(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_nav_item_hidden_without_permission(self, jinja_env, mock_user_customer, mock_can_helper_restricted, mock_has_helper):
    ...
    def test_nav_item_active_state(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_nav_item_with_badge(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_nav_item_disabled(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
...
class TestProtectedContent:
    ...
    def test_content_renders_with_permission(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_content_hidden_without_permission(self, jinja_env, mock_user_customer, mock_can_helper_restricted, mock_has_helper):
    ...
    def test_content_shows_fallback_message(self, jinja_env, mock_user_customer, mock_can_helper_restricted, mock_has_helper):
...
class TestRBACPageHeader:
    ...
    def test_page_header_with_title(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_page_header_with_subtitle(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_page_header_with_actions(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
...
class TestRBACTableActions:
    ...
    def test_table_actions_render_with_permission(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_table_actions_hidden_without_permission(self, jinja_env, mock_user_customer, mock_can_helper_restricted, mock_has_helper):
...
class TestNavigationComponents:
    ...
    def test_sidebar_renders(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
    ...
    def test_navbar_renders(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
...
class TestTableUtilities:
    ...
    def test_empty_state_renders(self, jinja_env, mock_user_superadmin, mock_can_helper, mock_has_helper):
