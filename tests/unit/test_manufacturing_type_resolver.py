...
class TestManufacturingTypeResolver:
    ...
    @pytest.mark.asyncio
    async def test_get_default_for_page_type_valid(self, page_type: str, manufacturing_category: str):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("invalid", "Invalid page_type 'invalid'. Must be one of: {'profile', 'accessories', 'glazing'}"),
            ("", "Invalid page_type ''. Must be one of: {'profile', 'accessories', 'glazing'}"),
            ("PROFILE", "Invalid page_type 'PROFILE'. Must be one of: {'profile', 'accessories', 'glazing'}"),
        ],
