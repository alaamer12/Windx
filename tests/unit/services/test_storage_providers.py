...
class TestLocalStorageProvider:
    ...
    async def test_upload_file_with_content_type(self, local_provider):
        ...
        result = await local_provider.upload_file(
            file_content, filename, content_type="image/jpeg"
        )
...
class TestSupabaseStorageProvider:
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_upload_file_success(self, mock_create_client, supabase_settings, mock_supabase_client):
        ...
        mock_bucket.get_public_url.return_value = "https://test.supabase.co/storage/v1/object/public/test-bucket/file.jpg"
        ...
        assert result.filename.endswith(".jpg")
        assert result.url == "https://test.supabase.co/storage/v1/object/public/test-bucket/file.jpg"
        assert result.size == len(file_content)

    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_upload_file_failure(self, mock_create_client, supabase_settings, mock_supabase_client):
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_upload_file_exception(self, mock_create_client, supabase_settings, mock_supabase_client):
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_delete_file_success(self, mock_create_client, supabase_settings, mock_supabase_client):
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_delete_file_failure(self, mock_create_client, supabase_settings, mock_supabase_client):
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_get_file_url_exists(self, mock_create_client, supabase_settings, mock_supabase_client):
        ...
        mock_bucket.get_public_url.return_value = "https://test.supabase.co/storage/v1/object/public/test-bucket/test.jpg"
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_get_file_url_not_found(self, mock_create_client, supabase_settings, mock_supabase_client):
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_file_exists_true(self, mock_create_client, supabase_settings, mock_supabase_client):
    ...
    @patch('app.services.storage.supabase_provider.SUPABASE_AVAILABLE', True)
    @patch('app.services.storage.supabase_provider.create_client')
    async def test_file_exists_false(self, mock_create_client, supabase_settings, mock_supabase_client):
