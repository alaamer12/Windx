...
async def example_create_nodes_manually(
    service: HierarchyBuilderService, manufacturing_type_id: int
):
...
async def example_get_tree_as_json(service: HierarchyBuilderService, manufacturing_type_id: int):
...
async def example_generate_ascii_tree(service: HierarchyBuilderService, manufacturing_type_id: int):
...
async def example_generate_tree_plot(service: HierarchyBuilderService, manufacturing_type_id: int):
...
async def example_complex_hierarchy(service: HierarchyBuilderService, manufacturing_type_id: int):
