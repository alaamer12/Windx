...
class TestEntryServiceSchemaGeneration:
    ...
    def test_generate_form_schema_with_multiple_sections(self, entry_service, sample_attribute_nodes):
        ...
        assert len(schema.sections) == 4  # basic_information, dimensions, conditional_fields, pricing
    ...
    def test_create_field_definition_with_all_properties(self, entry_service):
        ...
        assert field.display_condition == {"operator": "greater_than", "field": "width", "value": 50}
