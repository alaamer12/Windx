...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('price_impact_type', sa.String(length=50), nullable=False, server_default="'fixed'"),
        ...
        sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['manufacturing_type_id'], ['manufacturing_types.id'], ondelete='CASCADE'),
    ...
    op.create_index('ix_attribute_nodes_manufacturing_type_id', 'attribute_nodes', ['manufacturing_type_id'])
    ...
    op.execute("ALTER TABLE attribute_nodes ALTER COLUMN ltree_path TYPE ltree USING ltree_path::ltree")
    op.create_index('idx_attribute_nodes_ltree_path', 'attribute_nodes', ['ltree_path'], postgresql_using='gist')
    ...
    op.create_table(
        ...
        sa.Column('calculated_weight', sa.Numeric(precision=10, scale=2), nullable=False, server_default='0'),
    ...
    op.create_index('ix_configurations_manufacturing_type_id', 'configurations', ['manufacturing_type_id'])
    ...
    op.create_table(
        ...
        sa.Column('calculated_price_impact', sa.Numeric(precision=10, scale=2), nullable=False, server_default='0'),
        sa.Column('calculated_weight_impact', sa.Numeric(precision=10, scale=2), nullable=False, server_default='0'),
    ...
    op.create_table(
        ...
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('manufacturing_type_id', sa.Integer(), nullable=False),
        sa.Column('template_type', sa.String(length=50), nullable=False, server_default="'standard'"),
    ...
    op.create_index('ix_configuration_templates_manufacturing_type_id', 'configuration_templates', ['manufacturing_type_id'])
    op.create_index('ix_configuration_templates_template_type', 'configuration_templates', ['template_type'])
    op.create_index('ix_configuration_templates_is_public', 'configuration_templates', ['is_public'])
    op.create_index('ix_configuration_templates_is_active', 'configuration_templates', ['is_active'])
    op.create_index('ix_configuration_templates_created_at', 'configuration_templates', ['created_at'])
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        sa.ForeignKeyConstraint(['template_id'], ['configuration_templates.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['attribute_node_id'], ['attribute_nodes.id'], ondelete='CASCADE')
    )
    ...
    op.create_index('ix_template_selections_attribute_node_id', 'template_selections', ['attribute_node_id'])
    op.create_index('ix_template_selections_created_at', 'template_selections', ['created_at'])
    
    # Convert selection_path column to LTREE type
    op.execute("ALTER TABLE template_selections ALTER COLUMN selection_path TYPE ltree USING selection_path::ltree")
    ...
    op.create_table(
        ...
        sa.Column('total_price', sa.Numeric(precision=12, scale=2), nullable=False),
        sa.Column('production_status', sa.String(length=50), nullable=False, server_default="'pending'"),
        sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.PrimaryKeyConstraint('id'),
